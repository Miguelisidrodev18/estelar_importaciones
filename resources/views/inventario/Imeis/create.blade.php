                ...
                <form action="{{ route('inventario.imeis.store') }}" method="POST" class="p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="codigo_imei" id="codigo_imei"
                                   ...
                                   placeholder="Ej: 123456789012345" maxlength="15" required>
                            <p class="mt-1 text-xs text-gray-500">
                                <i class="fas fa-info-circle mr-1"></i>
                                Código IMEI de exactamente 15 dígitos
                            </p>
                            @error('codigo_imei')
                            ...
                            <select name="producto_id" id="producto_id"
                                ...
                                @foreach($productos as $producto)
                                    @php
                                        ...
                                        $modeloNombre = $producto->modelo?->nombre ?? '';
                                        $label = trim("$marcaNombre $modeloNombre");
                                        if ($label && $label !== $producto->nombre) {
                                            $label = "$label ({$producto->nombre})";
                                        } elseif (!$label) {
